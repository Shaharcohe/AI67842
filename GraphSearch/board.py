...
from pieces import Piece, PieceList
...
class Move:
    ...
    def __init__(self, piece: Piece, piece_index, orientation, x=0, y=0):
        self.piece = piece
...
class Board:
    ...
    def __init__(self, board_w: int, board_h: int, num_players: int,
                 piece_list: PieceList, starting_point=(0, 0)):
        ...
        self.piece_list : PieceList = piece_list
        self.pieces = np.full((num_players, piece_list.get_num_pieces()), True, np.bool_)

    def add_move(self, player: int, move: Move):
        """
    ...
    def do_move(self, player: int, move: Move):
        """
    ...
    def check_move_valid(self, player: int, move):
        """
    ...
    def check_tile_legal(self, player: int, x: int, y: int):
        """
    ...
    def check_tile_attached(self, player: int, x: int, y: int):
