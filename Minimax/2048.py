...
from multi_agents import Evaluator
...
class GameRunner(object):
    """
    This class is responsible for creating the game and quitting it. It holds:
    - The game's GUI displayer
    - The game's agent (the player)
    and the game's technical preferences.
    """
    def __init__(self, size=const.BOARD_SIZE, display=None, agent=None, num_of_initial_tiles=NUM_OF_INITIAL_TILES,
    ...
    def new_game(self, initial_state=None, *args, **kw):
        ...
        if initial_state is None:
            initial_state = GameState(columns=self.size, rows=self.size)
...
def main():
    ...
    # todo - notice that I turned off the written display
